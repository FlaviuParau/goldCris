...
class Blugento_Feeds_Model_Feed_Save_Provider_Googleshopping extends Blugento_Feeds_Model_Feed_Save_Xml
{
    /**
     * Definition filename
     * @var string
     */
    protected $_definitionFilename = 'googleshopping.xml';
    ...
    public function buildXMLString(array $content)
    {
        ...
        $XML = $this->createElement('channel');
        ...
        foreach ($content as $product) {
            try {
                $XMLProduct = $this->createElement('item');
