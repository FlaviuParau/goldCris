...
class Blugento_Importer_Block_Adminhtml_System_Convert_Profile_Test extends Mage_Adminhtml_Block_Abstract
{
    /**
    ...
    public function getTestResult()
    {
        ...
        foreach ($profile->getSampleData() as $e) {
            $sampleData[] = array(
                "message"   => $e->getMessage(),
            );
        }
        ...
        $result->setTestResultErrors($exceptions);
