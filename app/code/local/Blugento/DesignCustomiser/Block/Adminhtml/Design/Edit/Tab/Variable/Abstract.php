...
abstract class Blugento_DesignCustomiser_Block_Adminhtml_Design_Edit_Tab_Variable_Abstract
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
            ...
            Varien_Data_Form $form)
    {
        ...
        foreach ($collection as $variable) {
            ...
            $fieldsetId = 'fieldset_' . md5($fieldset);
            ...
            Varien_Data_Form $form)
    {
        ...
        foreach ($collection as $variable) {
             ...
             * @var $variable Blugento_DesignCustomiser_Model_Scss_Variable_Abstract
             */
            if (!$variable->getParentId() || $variable->getBasic() != 1) {
                continue;
            }
