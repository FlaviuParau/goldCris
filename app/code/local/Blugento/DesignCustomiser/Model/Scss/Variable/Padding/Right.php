...
class Blugento_DesignCustomiser_Model_Scss_Variable_Padding_Right
    extends Blugento_DesignCustomiser_Model_Scss_Variable_Abstract
{
    /**
     * Padding_Right values
     * @var array
     */
    ...
    {
        return Mage::helper('blugento_designcustomiser')->getAllowedVariableType('padding_right');
    }
