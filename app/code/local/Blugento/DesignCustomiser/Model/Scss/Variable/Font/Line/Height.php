...
class Blugento_DesignCustomiser_Model_Scss_Variable_Font_Line_Height
    extends Blugento_DesignCustomiser_Model_Scss_Variable_Abstract
{
    ...
    {
        return Mage::helper('blugento_designcustomiser')->getAllowedVariableType('font_line_height');
    }
