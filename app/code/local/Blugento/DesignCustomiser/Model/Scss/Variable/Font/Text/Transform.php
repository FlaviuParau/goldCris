...
class Blugento_DesignCustomiser_Model_Scss_Variable_Font_Text_Transform
    extends Blugento_DesignCustomiser_Model_Scss_Variable_Abstract
{
    ...
    {
        return Mage::helper('blugento_designcustomiser')->getAllowedVariableType('font_text_transform');
    }
