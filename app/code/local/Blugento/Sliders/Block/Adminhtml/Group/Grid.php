...
class Blugento_Sliders_Block_Adminhtml_Group_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();

        $this->setId('blugento_sliders_group_grid');
    ...
    protected function _prepareLayout()
    {
        $this->setChild('add_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
                ...
                'class'     => 'add',
                'onclick'   => "setLocation('" . $this->getUrl('*/blugento_sliders_group/new') . "');",
            ))
        );
    ...
    {
        $this->setCollection(Mage::getResourceModel('blugento_sliders/group_collection'));
            ...
            array(
                ...
                'actions'   => array(
                    array(
                        ...
                        'url'       => array('base' => '*/blugento_sliders_group/edit'),
                        'field'     => 'id'
                    )
                ),
                'filter'    => false,
    ...
    {
        return $this->getUrl('*/blugento_sliders_group/edit', array('id' => $row->getId()));
    }
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('delete', array(
            ...
            'url'       => $this->getUrl('*/blugento_sliders_group/massDelete'),
