 ...
 */
class Blugento_Pdf_Model_System_Config_Source_Shipment_Engine
{
    /**
     * Config xpath to pdf engine node
     *
     */
    const XML_PATH_PDF_ENGINE = 'global/pdf/blugento_shipment_engines';
    ...
    public function toOptionArray()
    {
        ...
        $engines = array(
            ...
            'blugento_pdf/engine_shipment_default' => Mage::helper('blugento_pdf')->__('Standard Blugento')
        );
