 ...
 */
class Blugento_Pdf_Model_System_Config_Source_Creditmemo_Engine
{
    /**
     * Config xpath to pdf engine node
     *
     */
    const XML_PATH_PDF_ENGINE = 'global/pdf/blugento_creditmemo_engines';
    ...
    public function toOptionArray()
    {
        ...
        $engines = array(
            ...
            'blugento_pdf/engine_creditmemo_default' => Mage::helper('blugento_pdf')->__('Standard Blugento'),
            'blugento_pdf/engine_creditmemo_romania' => Mage::helper('blugento_pdf')->__('Standard Romania')
        );
