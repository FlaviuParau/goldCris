 ...
 */
class Blugento_Pdf_Model_Items_Ro_Creditmemo_Default extends Mage_Sales_Model_Order_Pdf_Items_Invoice_Default
{
    ...
    public function draw($position = 1)
    {
        ...
        $columns['price_excl_tax'] = array(
            'text'      => $this->formatTxtPrice(($item->getRowTotalInclTax() - $tax)/$qty),
            'align'     => 'right',
            'font_size' => $fontSize,
            '_width'    => 60
        );
        ...
        $columns['subtotal'] = array(
            'text'      => $this->formatTxtPrice($item->getRowTotal() * -1),
            'align'     => 'right',
            'font_size' => $fontSize,
            '_width'    => 50
        );
        ...
        $columns['subtotal_incl_tax'] = array(
            'text'      => $item->getRowTotalInclTax() * -1,
            'align'     => 'right',
            'font_size' => $fontSize,
            '_width'    => 70
        );
        ...
        $columns['subtotal_excl_tax'] = array(
            'text'      => $this->formatTxtPrice(($item->getRowTotalInclTax() - $tax) * -1),
            'align'     => 'right',
            'font_size' => $fontSize,
            '_width'    => 70
        );
