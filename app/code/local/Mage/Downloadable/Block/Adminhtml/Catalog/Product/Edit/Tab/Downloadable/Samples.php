		...
		$this->getUploaderConfig()
			...
			->setTarget(
				Mage::getModel('adminhtml/url')
					// Bugfix BCBS-2889
					// This method adds ?SID= to the URL, and appears to be a bug in 1.9.4.5.
					// Request changes/losses it's session param resulting in redirect to login page and no file upload
					//->addSessionParam()
