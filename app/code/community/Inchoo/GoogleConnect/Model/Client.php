...
class Inchoo_GoogleConnect_Model_Client
{
    ...
    const XML_PATH_ENABLED = 'blugento_socialmedia/inchoo_googleconnect/enabled';
    const XML_PATH_CLIENT_ID = 'blugento_socialmedia/inchoo_googleconnect/client_id';
    const XML_PATH_CLIENT_SECRET = 'blugento_socialmedia/inchoo_googleconnect/client_secret';
