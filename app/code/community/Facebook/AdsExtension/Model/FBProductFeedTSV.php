...
// ref: https://developers.facebook.com/docs/marketing-api/dynamic-product-ads/product-catalog
  const TSV_HEADER = "id\ttitle\tdescription\tlink\timage_link\tbrand\tcondition\tavailability\tprice\tshort_description\tproduct_type\tgoogle_product_category\tadditional_image_link";
  const TWO_PRICES_TSV_HEADER = "id\ttitle\tdescription\tlink\timage_link\tbrand\tcondition\tavailability\tprice\tsale_price\tshort_description\tproduct_type\tgoogle_product_category\tadditional_image_link";
  ...
  protected function buildHeader() {
      if (Mage::getStoreConfig('Facebook_AdsExtension/product_feed/two_prices')) {
          $header = self::TWO_PRICES_TSV_HEADER;
      } else {
          // shame that we can not insert any comments in TSV
          $header = self::TSV_HEADER;
      }
