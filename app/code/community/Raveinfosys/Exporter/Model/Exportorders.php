...
class Raveinfosys_Exporter_Model_Exportorders extends Raveinfosys_Exporter_Model_Exporter
{
    ...
    protected function getCommonOrderValues($order)
    {
        ...
        return array(
            ...
            $this->formatText($order->getBillingAddress()->getData('blugento_customer_reg_no')),
            $this->formatText($order->getBillingAddress()->getData('blugento_customer_iban')),
            $this->formatText($order->getBillingAddress()->getData('blugento_customer_bank')),
            $this->formatText($order->getBillingAddress()->getData('blugento_customer_headquarter')),
            $this->formatText($order->getBillingAddress()->getData('blugento_customer_cnp')),
            $order->getBillingAddress()->getData('fax'),
            $order->getData('smartbill_document_series') . $order->getData('smartbill_document_number'),
            $order->getData('customer_id'),
            ...
            $this->formatText($shippingAddress->getData('blugento_customer_reg_no')),
            $this->formatText($shippingAddress->getData('blugento_customer_iban')),
            $this->formatText($shippingAddress->getData('blugento_customer_bank')),
            $this->formatText($shippingAddress->getData('blugento_customer_headquarter')),
            $this->formatText($shippingAddress->getData('blugento_customer_cnp')),
