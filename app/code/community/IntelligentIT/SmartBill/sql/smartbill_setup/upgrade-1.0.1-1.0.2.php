...
$installer->getConnection()->modifyColumn($installer->getTable('sales/order'), 'smartbill_external_document_url', 'TEXT');

$newInvoiceEmail = Mage::getModel('core/email_template');
$newInvoiceEmail->loadByCode('Smartbill Invoice Email Template');
            ...
            <table cellspacing="0" cellpadding="0" class="message-container">
                <tr>
                    <td><span>Vezi factura: <span/>
                        <p>
                            <a href="{{var external_url}}">Descarca factura</a>
                        </p>
                    </td>
                </tr>
            </table>
