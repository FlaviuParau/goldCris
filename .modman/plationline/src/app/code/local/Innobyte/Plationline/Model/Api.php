...
class Innobyte_Plationline_Model_Api extends Mage_Payment_Model_Method_Abstract
{
    ...
    public function getFormFields($order)
    {
        ...
        if (strlen($billingAddress->getTelephone()) >= 4) {
        ...
        if (isset($shipping) && !empty($shipping)) {
            ...
            if (strlen($shipping->getTelephone()) >= 4) {
        ...
        $f_request['f_order_string'] = 'Comanda nr. '.$order->getIncrementId().' pe site-ul '. Mage::getBaseUrl();
