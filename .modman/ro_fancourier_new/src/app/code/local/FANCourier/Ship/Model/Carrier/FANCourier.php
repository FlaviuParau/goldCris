                ...
                if (is_numeric($q)) {
                            ...
                            if (count($results)>0){
                                        ...
                                        if ($ramburs and ($cashondelivery==0 or ($cashondelivery==1 and $payment_cashondelivery=='cashondelivery')))
										{
                                            if ($contcolector)
											{
                                                $rambursare = number_format(round((float)$results[0]["subtotal_incl_tax"],2), 2, '.', '');
                                                $rambursare_number = round((float)$results[0]["subtotal_incl_tax"],2)+0;
											...
											{
                                                $rambursare = (string)number_format(round((float)$results[0]["subtotal_incl_tax"],2), 2, '.', '')." LEI";
                                                $rambursare_number = round((float)$results[0]["subtotal_incl_tax"],2)+0;
