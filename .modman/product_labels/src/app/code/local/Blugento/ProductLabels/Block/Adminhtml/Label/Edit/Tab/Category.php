...
class Blugento_ProductLabels_Block_Adminhtml_Label_Edit_Tab_Category extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $this->setForm($form);
        $fieldset = $form->addFieldset('productlabels_form', array('legend' => Mage::helper('blugento_productlabels')->__('Category Page')));
        ...
        $fieldset->addField(
            ...
            'select',
            array(
                'label' => Mage::helper('blugento_productlabels')->__('Enable on Category Page'),
                'name' => 'enabled_on_category',
