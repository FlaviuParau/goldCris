...
abstract class Blugento_DesignCustomiser_Model_Scss_Variable_Abstract extends Varien_Object
{
    /**
     * Variable id
     * @var string
    ...
    /**
     * Is variable allowing inheritage
     * @var type
     */
    protected $_allowInherit = '';

    /**
     * Is variable allowing null value
     * @var type
     */
     ...
     * @var string
     */
    protected $_defaultRenderClass = 'blugento_designcustomiser/adminhtml_form_renderer_variable_default';
     ...
     * @var string
     */
    protected $_translationPrefix = 'scss';

    /**
     * Variable displayed in basic or advanced tab
     * @var string
     */
    protected $_basic = '';
    ...
    protected function _initFromXml(Varien_Simplexml_Element $elementVariableXml)
    {
        ...
        $this->_tooltip         = (string)$elementVariableXml->tooltip;
        $this->_help            = (string)$elementVariableXml->help;
        $this->_default         = (string)$elementVariableXml->default;
        $this->_allowInherit    = (string)$elementVariableXml->allowinherit;
        $this->_allowNull       = (string)$elementVariableXml->allownull;
        $this->_parentId        = (string)$elementVariableXml->parent;
        $this->_fieldset        = (string)$elementVariableXml->fieldset;
        $this->_tab             = (string)$elementVariableXml->tab;
        $this->_basic           = (int)$elementVariableXml->basic;
        return $this;
    }
    ...
    {
        if (is_string($this->_allowInherit)) {
            return ($this->_allowInherit === 'true' ? true : false);
        }
    ...
    {
        if (is_string($this->_allowNull)) {
            return ($this->_allowNull === 'true' ? true : false);
        }
    ...
    /**
     * Get Variable Value
     * @param Blugento_DesignCustomiser_Model_Scss_Save_Interface $valuesFile
     * @return string
     */
    final public function getValue(Blugento_DesignCustomiser_Model_Scss_Save_Interface $valuesFile)
    {
    ...
    /**
     * Determines if the variable value is inherited from other variable
     * @return bool
     */
    ...
    /**
     * Get basic tab or advanced tab
     * @return int
     */
    public function getBasic()
    {
        if (is_int($this->_basic)) {
            return $this->_basic == 1 ? 1 : 0;
        }
