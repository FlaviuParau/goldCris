...
class Blugento_DesignCustomiser_Block_Adminhtml_Design_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function __construct()
    {
        ...
        $this->addButton('advanced_mode', array(
            'label'   => $this->__('Switch to Advanced Mode'),
            'onclick' => 'confirmSetLocation(\''. $this->__('Do you really want to switch to advanced mode?') .'\', \'' 
                . $this->getUrl('*/adminhtml_advanced') .'\')',
            'class'   => 'advanced'
        ));
    }
