...
abstract class Blugento_DesignCustomiser_Block_Adminhtml_Layout_Edit_Tab_Abstract
    extends Mage_Adminhtml_Block_Widget_Form
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    /**
     * Collection model
     * @var Blugento_DesignCustomiser_Model_Layout_Variable_Collection_Abstract
     */
    ...
    protected function _construct()
    {
        parent::_construct();
        $this->_setCollection();
        if (!($this->_collection instanceof Blugento_DesignCustomiser_Model_Layout_Variable_Collection_Abstract)) {
     ...
     * Set collection
     *
     * @return Blugento_DesignCustomiser_Block_Adminhtml_Layout_Edit_Tab_Abstract
     */
    ...
    protected function _prepareForm()
    {
        ...
        Mage::helper('blugento_designcustomiser')->getLayoutDefinitionModel()->setSession(Mage::getSingleton('adminhtml/session'));

        /**
         * @var $collection Blugento_DesignCustomiser_Model_Layout_Variable_Collection_Abstract
         */
        $collection = array();
            ...
            Varien_Data_Form $form)
    {
        ...
        foreach ($collection as $variable) {
            ...
            $fieldsetId = strtolower(str_replace(' ', '_', $fieldset));
     ...
     * @return Blugento_DesignCustomiser_Block_Adminhtml_Layout_Edit_Tab_Abstract
     */
    protected function _setChildrenVariable(Blugento_DesignCustomiser_Model_Layout_Variable_Collection_Abstract $collection,
            Varien_Data_Form $form)
    {
