...
class Blugento_DesignCustomiser_Block_Adminhtml_Export extends Mage_Adminhtml_Block_Widget_Form
...
//        $data = $helper->getFinalCssDefinitionModel()->loadContent();
    ...
    {
        if($this->canShowTab()) {
            return Mage::helper('blugento_designcustomiser')->__('Export/Import');
        }
    }
