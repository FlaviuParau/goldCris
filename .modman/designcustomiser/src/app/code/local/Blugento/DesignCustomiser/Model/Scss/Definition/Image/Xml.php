...
class Blugento_DesignCustomiser_Model_Scss_Definition_Image_Xml
    extends Blugento_DesignCustomiser_Model_Scss_Definition_Xml_Abstract
{
   /**
     ...
     * @return Blugento_DesignCustomiser_Model_Scss_Definition_Xml
     */
