...
abstract class Blugento_DesignCustomiser_Model_Scss_Definition_Xml_Abstract
    extends Varien_Simplexml_Config
    implements Blugento_DesignCustomiser_Model_Scss_Definition_Interface
{
    /**
     * Variables array
     * @var array
    ...
    /**
     * Set helper
     * @return Blugento_DesignCustomiser_Model_Scss_Definition_Xml_Abstract
     */
    ...
    public function getVariables()
    {
        ...
        try {
            ...
            $initialEnvironmentInfo = $appEmulation->startEnvironmentEmulation(
                $this->_helper->getScssDefinitionStore()
            );

            $fileSpecsDefinitionXML = $this->_helper->getScssDefinitionFile();

            $appEmulation->stopEnvironmentEmulation($initialEnvironmentInfo);

            if (empty($fileSpecsDefinitionXML)) {
                $this->setMessage('error', "No specification Scss file is set on the default theme.");
            }
            ...
            if (!$totalChildren) {
                $this->setMessage('error', "No Scss variable definition in file.");
            }
    ...
    public function getVariableType($variable)
    {
        ...
        return $this->_helper->getAllowedVariableType($type);
    }
     ...
     * @return Blugento_DesignCustomiser_Model_Scss_Definition_Image_Xml
