...
class Blugento_DesignCustomiser_Block_Adminhtml_Grunt_Edit_Tab_Logs extends Mage_Adminhtml_Block_Widget_Form
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('base_fieldset', array(
            'legend' => Mage::helper('blugento_designcustomiser')->__('Grunt Logs'),
            'class'  => 'fieldset-wide',
        ));
        
        $fieldset->addField('logs', 'textarea', array(
            'name'      => 'logs',
            'class'     => 'fieldset-wide',
            'style'     => 'height:24em;',
            'disabled'  => true,
        ...
        $form->setValues(array('logs' => $data));
        $this->setForm($form);
    ...
    {
        return Mage::helper('blugento_designcustomiser')->__('View Log File');
    }
