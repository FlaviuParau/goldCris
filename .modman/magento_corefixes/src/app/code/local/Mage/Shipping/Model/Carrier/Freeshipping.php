    ...
    implements Mage_Shipping_Model_Carrier_Interface
{
    ...
    public function collectRates(Mage_Shipping_Model_Rate_Request $request)
    {
        ...
        if (($request->getFreeShipping())
            ...
            || $this->isFreeForRecurrentPayments($request)
        ) {
    ...
    /**
     * Check if order amount is greater than freeshipping for recurrent payments
     *
     * @param Mage_Shipping_Model_Rate_Request $request
     * @return bool
     */
    protected function isFreeForRecurrentPayments($request)
    {
        ...
        if ($amount >= $this->getConfigData('free_shipping_subtotal')) {
            return true;
        } else {
            return false;
        }
