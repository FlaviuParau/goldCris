...
class Blugento_Feeds_Model_Feed_Provider_Gacustom extends Blugento_Feeds_Model_Feed_Abstract
{
    /**
     * @return string
     */
    ...
    {
        if (Mage::helper('blugento_feeds')->getGaCustomDownloadOption() == 'xml') {
    ...
    public function setContentType()
    {
        ...
        } elseif (Mage::helper('blugento_feeds')->getGaCustomDownloadOption() == 'csv') {
    ...
    {
        if (Mage::helper('blugento_feeds')->getGaCustomDownloadOption() == 'xml') {
            $this->_feedSaveModel = 'blugento_feeds/feed_save_provider_gacustom';
        } else {
            $this->_feedSaveModel = 'blugento_feeds/feed_save_provider_gacustomCsv';
        }
    ...
    public function getProducts($args)
    {
        ...
        $productAttributes = array('visibility', 'status', 'name', 'price', 'special_price', 'url_path', 'description',
            'short_description', 'image', 'special_from_date', 'special_to_date', 'manufacturer');
...
//            $productsData[$key]['g:brand'] = $product['manufacturer'];
        ...
        //if (Mage::helper('blugento_feeds')->getGaCustomDownloadOption() == 'csv') {
            $tableHeaders = array(
                'g:id'            => 'ID',
                'g:mpn'           => 'ID2',
                'title'           => 'Item title',
