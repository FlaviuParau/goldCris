 ...
 *
 * @category    Blugento
 * @package     Blugento_FancourierDiscountFix
 * @author      Mihai Rastasan <mihai.rastasan@blugento.ro>
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */

class Blugento_FancourierDiscountFix_Model_Carrier_FANCourier extends FANCourier_Ship_Model_Carrier_FANCourier
{
    /**
    ...
    public function collectRates(Mage_Shipping_Model_Rate_Request $request)
    {
        ...
        if (is_numeric($q)) {
            ...
            if (count($results)>0){
                ...
                $rambursare_number = $request->getPackageValue();
                if (Mage::getStoreConfig('blugento_fancourierdiscountfix/general/enabled')) {
                    $rambursare_number = $request->getPackageValueWithDiscount();
                }
