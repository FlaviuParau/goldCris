...
class Magestore_Fblogin_IndexController extends Mage_Core_Controller_Front_Action
{
	...
	protected function createCustomer($data){
		...
		$isSendPassToCustomer = Mage::getStoreConfig('blugento_socialmedia/login_general/is_send_password_to_customer');
	...
	//add old
        protected function _loginPostRedirect(){
            $selecturl= Mage::getStoreConfig(('blugento_socialmedia/login_general/select_url'),Mage::app()->getStore()->getId());
            ...
            if($selecturl==4) return Mage::getStoreConfig(('blugento_socialmedia/login_general/custom_page'),Mage::app()->getStore()->getId());
