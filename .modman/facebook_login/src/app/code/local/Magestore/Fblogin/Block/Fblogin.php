...
class Magestore_Fblogin_Block_Fblogin extends Mage_Core_Block_Template
{
	...
	public function getAppId(){
		return Mage::getStoreConfig('blugento_socialmedia/login_general/app_id');
	}
	
	public function getNotConnectedTemplate(){
		$template = Mage::getStoreConfig('blugento_socialmedia/login_general/not_connected_template');
	...
	public function getConnectedTemplate(){
		...
		$template = Mage::getStoreConfig('blugento_socialmedia/login_general/connected_template');
	...
	public function isShowAvatar(){
		return Mage::getStoreConfig('blugento_socialmedia/login_general/is_show_avatar');
	}
