 ...
 * Add is_required column in checkout_agreement if it does not exist
 */
 ...
 * Add is_required column in checkout_agreement if it does not exist
 */
$info = $installer->getConnection()->describeTable('checkout_agreement');

if (!isset($info['is_required'])) {
