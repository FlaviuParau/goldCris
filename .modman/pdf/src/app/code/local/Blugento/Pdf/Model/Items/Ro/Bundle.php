 ...
 */
class Blugento_Pdf_Model_Items_Ro_Bundle extends Mage_Bundle_Model_Sales_Order_Pdf_Items_Invoice
{
        ...
        foreach ($items as $_item) {
            ...
            if ($this->canShowPriceInfo($_item)) {
                ...
                $columns['subtotal_excl_tax'] = array(
                    'text'      => $this->formatTxtPrice($_item->getRowTotalInclTax() - $tax),
                    'align'     => 'right',
                    'font_size' => $fontSize,
                    '_width'    => 70
                );
