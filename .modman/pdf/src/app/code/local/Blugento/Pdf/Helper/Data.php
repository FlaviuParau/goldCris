 ...
 */
class Blugento_Pdf_Helper_Data extends Mage_Core_Helper_Abstract
{
    const XML_PATH_BLUGENTO_PDF_LOGO_POSITION = 'sales_pdf/blugento_pdf/logo_position';
    ...
    const XML_PATH_SALES_PDF_BLUGENTO_PDF_PAGE_SIZE = 'sales_pdf/blugento_pdf/page_size';

    const XML_PATH_REGULAR_FONT = 'sales_pdf/blugento_pdf_fonts/regular_font';
    const XML_PATH_BOLD_FONT = 'sales_pdf/blugento_pdf_fonts/bold_font';
    const XML_PATH_ITALIC_FONT = 'sales_pdf/blugento_pdf_fonts/italic_font';

    const FONT_PATH_IN_MEDIA = '/blugento_pdf/fonts';
    ...
    public function isLogoFullWidth($store)
    {
        $configSetting = Mage::getStoreConfig(
            self::XML_PATH_BLUGENTO_PDF_LOGO_POSITION, $store
        );
        $fullWidth = Blugento_Pdf_Model_System_Config_Source_Logo::FULL_WIDTH;
    ...
    {
        return Mage::getStoreConfig(self::XML_PATH_SALES_PDF_BLUGENTO_PDF_PAGE_SIZE);
    }

    /**
     * Check if include invoice pdf in email is enable.
     *
     * @return boolean
     */
    public function includeInvoicePdfInEmail() {
        return Mage::getStoreConfig('sales_pdf/invoice/pdf_invoice_email');
    }
}
