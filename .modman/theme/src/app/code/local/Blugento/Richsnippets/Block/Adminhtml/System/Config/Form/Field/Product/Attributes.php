...
class Blugento_Richsnippets_Block_Adminhtml_System_Config_Form_Field_Product_Attributes extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    /**
     * @var Blugento_Richsnippets_Block_Adminhtml_System_Config_Form_Field_Product_Attributes _attributesRenderer
     */
    protected $_attributesRenderer;
	
	/**
	 * @var Blugento_Richsnippets_Block_Adminhtml_System_Config_Form_Field_Product_Attributes _attributeSetRenderer
	 */
     ...
     *
     * @return Blugento_Richsnippets_Block_Adminhtml_System_Config_Form_Field_Product_Attributes
     */
    protected function _getAttributeRenderer()
    {
        if (!$this->_attributesRenderer) {
            $this->_attributesRenderer = $this->getLayout()->createBlock(
                'blugento_richsnippets/adminhtml_system_config_form_field_product_select_attributes',
                '',
                array(
	...
	protected function _getAttributeSetRenderer()
	{
		if (!$this->_attributeSetRenderer) {
			$this->_attributeSetRenderer = $this->getLayout()->createBlock(
				'blugento_richsnippets/adminhtml_system_config_form_field_product_select_attributesSet',
				'',
				array(
					'is_render_to_js_template' => true
				)
    ...
    protected function _prepareToRender()
    {
	    ...
	    $this->addColumn(
		    'attribute_set', array(
			    'label'    => Mage::helper('blugento_richsnippets')->__('Attribute Set'),
