...
class Blugento_Theme_Block_Catalog_Product_List_Upsell extends Mage_Catalog_Block_Product_List_Upsell
{
    ...
    public function addHomepagemanagerLayoutOptions()
    {
        ...
        $layoutOptions = array (
            ...
            'product_view_upsell_products_status' => (int) (Mage::app()->getLayout()->getBlock('root')->getProductViewUpsellProductsStatus() ?: 1),
            'product_view_upsell_products_slider_status' => (int) (Mage::app()->getLayout()->getBlock('root')->getProductViewUpsellProductsSliderStatus() ?: 1),
            'product_view_upsell_products_slider_slides_to_show' => (int) (Mage::app()->getLayout()->getBlock('root')->getProductViewUpsellProductsSliderSlidesToShow() ?: 4),
            'product_view_upsell_products_slider_slides_to_scroll' => (int) (Mage::app()->getLayout()->getBlock('root')->getProductViewUpsellProductsSliderSlidesToScroll() ?: 1),
            'product_view_upsell_products_slider_animation' => (int) (Mage::app()->getLayout()->getBlock('root')->getProductViewUpsellProductsSliderAnimation() ?: 300),
            'product_view_upsell_products_slider_loop' => (int) (Mage::app()->getLayout()->getBlock('root')->getProductViewUpsellProductsSliderLoop() ?: 2),
            'product_view_related_products_slider_center' => (int) (Mage::app()->getLayout()->getBlock('root')->getProductViewUpsellProductsSliderCenter() ?: 2),
            'product_view_related_products_slider_dots' => (int) (Mage::app()->getLayout()->getBlock('root')->getProductViewUpsellProductsSliderDots() ?: 2),
            'product_view_upsell_products_slider_mobile' => (int) (Mage::app()->getLayout()->getBlock('root')->getProductViewUpsellProductsSliderMobile() ?: 2),
