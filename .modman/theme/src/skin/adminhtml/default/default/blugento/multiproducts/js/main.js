...
Blugento.MultiProducts = Class.create({
    ...
    initialize: function()
    {
        var typeOfTemplate = $$('select[name="parameters[type_of_template]"]')[0],
            typeOfTemplateValue = 0,
            productSlider = $$('select[name="parameters[product_slider]"]')[0],
            productSliderValue = 0;

        this.typeOfTemplate = $$('select[name="parameters[type_of_template]"]')[0];
        this.productSlider = $$('select[name="parameters[product_slider]"]')[0];
...
Blugento.ProductWidget = Class.create({
