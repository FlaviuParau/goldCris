...
class Blugento_Googleshopping_Adminhtml_GoogleshoppingController extends Mage_Adminhtml_Controller_Action
{
    ...
    /**
     * @var Blugento_Googleshopping_Model_Googleshopping
     */
    public $feed;
            ...
            if (Mage::getStoreConfig('googleshopping/general/enabled')) {
                ...
                if (!empty($storeId)) {
                    ...
                    if ($fileName = $this->feed->getFileName('googleshopping', $storeId, 'preview')) {
                        $filePath = Mage::getBaseDir() . DS . 'media' . DS . 'googlefeed' . DS . $fileName;
                    }
    ...
    public function downloadAction()
    {
        try {
            ...
            if ($fileName = $this->feed->getFileName('googleshopping', $storeId)) {
                $filePath = Mage::getBaseDir() . DS . 'media' . DS . 'google-feed' . DS . $fileName;
            }
