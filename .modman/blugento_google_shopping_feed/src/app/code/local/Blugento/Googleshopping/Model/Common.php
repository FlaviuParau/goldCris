...
class Blugento_Googleshopping_Model_Common extends Mage_Catalog_Model_Resource_Abstract
{

    /**
     * @param        $config
     *
     * @return Blugento_Googleshopping_Model_Resource_Product_Collection
    ...
    public function getProducts($config)
    {
        ...
        /** @var Blugento_Googleshopping_Model_Resource_Product_Collection $collection */
    ...
    /**
     * @param Blugento_Googleshopping_Model_Resource_Product_Collection $collection
     * @param                                                             $config
     */
