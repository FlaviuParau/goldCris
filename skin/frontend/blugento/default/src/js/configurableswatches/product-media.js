...
var ConfigurableMediaImages = {
    ...
    updateImage: function(el) {
        var select = $j(el),
            label = select.find('option:selected').attr('data-attr-id'),
            swatchImage = select.attr('data-image'),
            productId = optionsPrice.productId; //get product ID from options price object
